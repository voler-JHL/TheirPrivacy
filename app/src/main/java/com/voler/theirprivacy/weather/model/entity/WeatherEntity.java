package com.voler.theirprivacy.weather.model.entity;
...
public class WeatherEntity {
    ...
    private List<HeWeatherSataServiceBean> HeWeatherDataService;

    public List<HeWeatherSataServiceBean> getHeWeatherDataService() {
        return HeWeatherDataService;
    }

    public void setHeWeatherDataService(List<HeWeatherSataServiceBean> HeWeatherDataService) {
        this.HeWeatherDataService = HeWeatherDataService;
    }

    public static class HeWeatherSataServiceBean {
        /**
         * status : ok
